...
function emailregister($email,$nama,$alamat,$id_kota,$telp,$kodepos,$code){
	...
	$footer	=" Untuk Melanjutkan Aktivitas Belanja Anda, Silahkan Verifikasi Akun Anda<br /><br />
			   ...
			   <a href='http://tokomusikkharisma.com/index.php?page=home&code=$code'>http://tokomusikkharisma.com/index.php?page=home&code=$code</a><br />
...
function emailshipping($id_pembelian,$email){
	...
	$bayaran ="Pembayaran dapat pesanan dilakukan Menggukakan metode pembayaran yang kami gunakan dibawah ini :
			...
			<tr>
				<td colspan=3><a href='http://tokomusikkharisma.com/?page=view&idn=$id_pembelian'>
				<img src='http://tokomusikkharisma.com/images/btn.gif'></a></td>
			</tr>";
	...
	$bayaran .="
			<tr>
              ...
              <a href='http://tokomusikkharisma.com/?page=view&idn=$id_pembelian'>
			  <img src='http://tokomusikkharisma.com/images/$rek[gambar_rekening]'></a></td>
