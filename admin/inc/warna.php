        ...
        <table>
        	...
        	<tr>
            	<td colspan="2" align="center">
                    ...
                    <a class="button red" href="?page=warna"/><span class="label1">Batal</span></a></td>
            </tr>
        </table>
	</form>
    <?php
...
?>
    ...
    <tr>
    <td align="right">
	<a href="?page=warna&act=add" class="button blue">
    <span class="label1">Tambah Warna</span></a>
    </td>
...
<table width="592" id="rounded-corner">
    ...
    <tbody>
		...
		?>
            ...
            <td><a href="?page=warna&act=edit&idu=<?php echo $dwarna['id_warna']; ?>" title="Ubah">
                	<span class="icon icon145"></span></a></td>
            <td width="45">
            	<a href="<?php echo $dwarna['id_warna']; ?>" id="warna" class="ask" title="Hapus">
