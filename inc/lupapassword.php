...
<div class="center_title_bar">Lupa Password</div>
	...
	?>
    	<p align="justify">Silahkan Masukkan Email Account anda Untuk Melakukan Verifikasi Lupa Password, Selanjutnya akan Kami Kirimkan Ke Email Anda</p>
    	<div style="padding-left:25%; padding-top:50px; padding-bottom:50px;">
    				<form action="" method="post">
					<table class="affiliateTable" border="0" cellpadding="0" cellspacing="0">
						<tbody>
							<tr>
								<td>Email</td>
								<td>
									: <input name="email" class="nameText" size="35" type="text">
								</td>
							</tr>
							<tr>
								<td colspan="2">&nbsp;</td>
							...
							<tr>
								<td>&nbsp;</td>
								<td>
									<input name="sendemail" value="Kirim Email" class="checkoutBtn" type="submit">
								</td>
							</tr>
						</tbody>
					</table>
