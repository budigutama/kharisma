...
?>
<div class="center_title_bar">Konfirmasi</div>
<div class="prod_box_big">
	<div class="center_prod_box_big">
          ...
          $qdetailpembelian = mysql_query("SELECT *
								...
								AND a.status_pengiriman = 'dipesan'
          ...
          ?>
            <tr>
                ...
                <td align="center"><a href="?page=viewkonfirmasi&idn=<?php echo $ddetailpembelian['id_detailpembelian']; ?>">View</a></td>
            </tr>
          <?php
          }
          ?>
