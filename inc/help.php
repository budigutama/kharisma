   	...
   	<div class="center_title_bar">Help</div>
    
    	<div class="prod_box_big">
      
            <div class="center_prod_box_big">
              <H3 align="left">Cara belanja</H3>
...
<p>Cara pembayaran</p>
<H3 align="left">Cara pembayaran</H3>
              <p align="left">1. Pembayaran dapat dilakukan dengan transfer bank <strong>BNI</strong> dengan no rekxxx dan bank Mandiri dengan no rek xxx juga dengan paypal</p>
              <p align="left"> 2. jika pembayaran dilakukan dengan cara tranfer total harga akan di tambahkan dua digit dari id member untuk menandai dari mana transfer dan melakukan konfirmasi melaui email atau pun ym</p>
            <H3 align="left">Cara pengiriman</H3>
              <p align="left">1. Pembayaran dapat dilakukan dengan transfer bank <strong>BNI</strong> dengan no rekxxx dan bank Mandiri dengan no rek xxx juga dengan paypal</p>
              <p align="left"> 2. jika pembayaran dilakukan dengan cara tranfer total harga akan di tambahkan dua digit dari id member untuk menandai dari mana transfer dan melakukan konfirmasi melaui email atau pun ym</p>
              
              
             <H3 align="left">Cara Ketentuan retur</H3>
              <p align="left">1. Pembayaran dapat dilakukan dengan transfer bank <strong>BNI</strong> dengan no rekxxx dan bank Mandiri dengan no rek xxx juga dengan paypal</p>
              <p align="left"> 2. jika pembayaran dilakukan dengan cara tranfer total harga akan di tambahkan dua digit dari id member untuk menandai dari mana transfer dan melakukan konfirmasi melaui email atau pun ym</p>
              
              
             <H3 align="left">Hubungi</H3>
              <p align="left">1. Pembayaran dapat dilakukan dengan transfer bank <strong>BNI</strong> dengan no rekxxx dan bank Mandiri dengan no rek xxx juga dengan paypal</p>
              <p align="left"> 2. jika pembayaran dilakukan dengan cara tranfer total harga akan di tambahkan dua digit dari id member untuk menandai dari mana transfer dan melakukan konfirmasi melaui email atau pun ym</p>
          </div> 
