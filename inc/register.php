	...
	if($_SESSION['string'] == $_POST['code']){
		$ncari = mysql_num_rows(mysql_query("SELECT *
			...
			if($ncari == 0){
				...
				mysql_query("INSERT INTO t_member VALUES(null, $_POST[kota], '$_POST[nama]', '$_POST[alamat]',
            ...
            <tr>
              ...
              <tr>
                ...
                <td align="left"><select name="provinsi" id="provinsi" class="inputan">
                  ...
                  <?php
                        $res=mysql_query("SELECT * FROM t_provinsi");
              ...
              <tr>
               ...
               <tr>
                <td colspan="2" align="center">
                	<button name="registrasi" value="Proses" class="action blue" />
                    <span class="label1">Simpan</span></button>
